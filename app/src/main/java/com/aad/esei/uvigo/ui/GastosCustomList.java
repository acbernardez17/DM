...
public class GastosCustomList extends ArrayAdapter {
    ...
    public GastosCustomList(Activity context, String[] tipoGastos, String[] FechaGastos, String[] KmGastos, String[] CantidadGastos, Integer[] idIcono) {
